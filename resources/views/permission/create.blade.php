...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Permission Page</li>
	</ol>
</section>
	...
	<div class="row">
		...
		@include("include.error")
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Permission Page</h3>
		...
		<div class="col-xs-4">
			<div class="panel panel-default">
			    <div class="panel-heading">Permission Page</div>
			    <div class="panel-body">
			        <form class="form-horizontal" role="form" method="POST" action="{{ url('permission/store') }}">
			            {{ csrf_field() }}
